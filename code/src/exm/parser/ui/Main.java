...
import exm.ast.SwiftScript;
import exm.parser.Settings;
import exm.parser.antlr.ExMLexer;
...
public class Main
{
   ...
   */
  static final String timestamp = Util.timestamp();
  ...
  public static void main(String[] args)
  {
    ...
    SwiftScript walker = new SwiftScript(inputFilename,
                           timestamp, output, icOutput, lineMapping);
    walk(walker, tree);
  }
  ...
  /**
     Walk the AST and produce the output
   */
  private static void walk(SwiftScript walker, SwiftAST tree)
  {
    try
    {
      walker.walk(tree);
