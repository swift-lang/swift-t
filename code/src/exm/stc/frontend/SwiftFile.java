...
public class SwiftFile {
  ...
  private ParsedFile parsed = null;
  
  public static class ParsedFile {
    public ParsedFile(String filePath, 
        String canonicalName, SwiftAST ast, LineMapping lineMapping) {
  ...
  public ParsedFile parse() throws IOException {
    ...
    return new ParsedFile(path, getCanonicalName(path), tree, lineMapping);
  }
   ...
   * @throws IOException 
   */
  public static String getCanonicalName(String filePath) throws IOException {
