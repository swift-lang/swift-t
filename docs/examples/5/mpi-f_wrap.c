...
#endif
SWIGINTERN int
_wrap_f(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  MPI_Comm arg1 ;
  int arg2 ;
  void *argp1 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:f comm k ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  {
    res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_MPI_Comm,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "f" "', argument " "1"" of type '" "MPI_Comm""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "f" "', argument " "1"" of type '" "MPI_Comm""'");
    } else {
      arg1 = *((MPI_Comm *)(argp1));
    }
  }
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "f" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  f(arg1,arg2);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "f", (swig_wrapper_func) _wrap_f, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int F_SafeInit(Tcl_Interp *interp) {
