...
# date                    : 2013/05/20 15:03:23
# Turbine version         : 0.1.0
# Input filename          : /home/wozniak/docs/stc/examples/1/test-f.swift
# Output filename         : /home/wozniak/docs/stc/examples/1/test-f.tcl
...
# stc.ic.output-file            : 
# stc.input_filename            : test-f.swift
# stc.log.file                  : 
# stc.log.trace                 : false
...
# stc.output_filename           : test-f.tcl
# stc.preprocess_only           : false
# stc.profile                   : false
# stc.rpath                     : /home/wozniak/docs/stc/examples/1
...
# rpath entries
lappend auto_path "/home/wozniak/docs/stc/examples/1"
...
proc f:f { stack u:o u:i1 u:i2 } {
    turbine::c::log "enter function: f"
    turbine::rule [ list ${u:i1} ${u:i2} ] "f-argwait ${stack} ${u:o} ${u:i2} ${u:i1}"
}


proc f-argwait { stack u:o u:i2 u:i1 } {
    # Value __v_i1 with type $int was defined
    # Value __v_i2 with type $int was defined
    # Value __v_o with type $int was defined
    set v:i1 [ turbine::retrieve_integer ${u:i1} CACHED 1 ]
    set v:i2 [ turbine::retrieve_integer ${u:i2} CACHED 1 ]
    set v:o [ my_pkg::f ${v:i1} ${v:i2} ]
    turbine::store_integer ${u:o} ${v:o}
}
...
proc swift:main {  } {
    ...
    set stack 0
    # Value __ov_z with type $int was defined
    # Value __ov___t0 with type $void was defined
    # Swift l.5: assigning expression to x
    # Swift l.6: assigning expression to y
    # Swift l.7: assigning expression to z
    set optv:z [ my_pkg::f 2 3 ]
    # Swift l.8 evaluating  expression and throwing away 1 results
    set optv:__t0 [ turbine::printf_local "sum: %i" ${optv:z} ]
}
