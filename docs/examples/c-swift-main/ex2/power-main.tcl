...
namespace eval power_main {

    proc power_main_wrap { rc A } {
        deeprule $A 1 0 "power_main::power_main_wrap_impl $rc $A"
    }

    proc power_main_wrap_impl { rc A } {
        ...
        set rc_value [ power_main_extension {*}$argv ]
