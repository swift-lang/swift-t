...
Proc. Petascale Data Storage Workshop (PDSW) at SC 2012.  +
 [http://www.mcs.anl.gov/~wozniak/papers/Triton_2012.pdf[PDF]]
 Slides: [http://www.mcs.anl.gov/~wozniak/papers/Triton_slides_2012.pdf[PDF]]
