...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body id="swift-t">
        <div class="container_12">
            <!-- header -->
            <img src="images/banner.gif" alt="Swift" width="750" height="89" border="0"  />
	    <!-- end header -->
...
<p>
Swift/T is an implementation of the Swift language (University of Chicago) for high-performance computing.  In this implementation, the Swift script is translated into an MPI program that uses the Turbine (hence, /T) and ADLB runtime libraries for highly scalable dataflow processing over MPI, without single-node bottlenecks.
</p>

<center>
      <div class="button_176" title="Main source code repository">
        <a href="http://github.com/swift-lang/swift-t">GitHub</a>
    </div>

    <div class="button_176" title="Entry point for Swift/T language and runtime guides">
        <a href="http://swift-lang.github.io/swift-t/guide.html">User Guide</a>
    </div>
    <div class="button_176" title="Plenty of useful examples for easy parallel programming">
        <a href="http://swift-lang.github.io/swift-t/gallery.html">Gallery</a>
    </div>
    <div class="button_176" title="Swift/T installation packages and prior versions">
