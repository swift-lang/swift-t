...
bool table_bp_add(struct table_bp *target,
               const char* key, void* data);

bool table_bp_set(struct table_bp* target, const char* key,
               void* value, void** old_value);

bool table_bp_search(const struct table_bp* target, const char* key,
                  void **value);

bool table_bp_contains(const struct table_bp* table, const char* key);

bool table_bp_remove(struct table_bp* table, const char* key,
                     void** data);
