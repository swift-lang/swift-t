...
/*
  ...
  This file is documented with maint/doc.sh
...
/** This allows us to extract C code into Asciidoc */
#define DOC_CODE(x) x

/**
   DOCN(== Struct +turbine_blob+)
...
/* DOCNN(`Functions for blob creation, memory allocation/deallocation,
